...
EncryptionUI::EncryptionUI(QWidget *parent):
    QWidget(parent)
{
 ...
 //  connect(encrptionFileBtn,SIGNAL(clicked()),this,SLOT(doEncryptionFile()));
 //  connect(encrptionStrBtn,SIGNAL(clicked()),this,SLOT(doEncryptionString()));
}
